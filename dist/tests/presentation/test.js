...
//create test object
const testObject1 = testObjectFunctions_1.default.createNewTestObject('Test of tenant id: 443', '443', requestParamaters, null, requestHeaders, '/transaction/2020');
//create test object list
const testObjectList1 = testObjectListFunctions_1.default.createNewTestObjectList(testObject1, '443', 20, true, 1);
...
//create test object
const testObject2 = testObjectFunctions_1.default.createNewTestObject('Test of tenant id: 91936', '91936', requestParamaters, null, requestHeaders, '/transaction/2021');
//create test object list
const testObjectList2 = testObjectListFunctions_1.default.createNewTestObjectList(testObject2, '91936', 20, true, 1);
//add the test object list to the tester
tester_1.default.addTestObjectList(testObjectList2);
//Add warm up test object and the total warm up rounds
tester_1.default.addWarmUpTestObject(testObject2, 5);
//Start the tests
