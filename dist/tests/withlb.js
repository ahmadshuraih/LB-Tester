...
const testObject = new TestObject_1.TestObject('test2', '00000', requestParamaters);
...
const testObjectList = new TestObjectList_1.TestObjectList(testObject, '00000', 500, true, 1);
