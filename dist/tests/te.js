...
configurator_1.default.setBaseUrl('http://localhost:3100/data/#{tenantId}/layout');
...
configurator_1.default.setRAMCheckRequestUrl('http://localhost:3100/loadbalancer/data?token=MasterToken');
...
const testObjectList1 = testObjectListFunctions_1.default.createNewTestObjectList(testObject1, '00000', 500, true, 1);
...
tester_1.default.addWarmUpTestObject(testObject1, 100);
//Start the tests
